...
class ScanCertificateController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        expireDataTimer = Timer.scheduledTimer(timeInterval: 30, target: self, selector: #selector(reloadExpiredData),
    ...
    // MARK: Actions
    @IBAction func reloadExpiredData() {
