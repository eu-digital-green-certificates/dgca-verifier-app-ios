...
// MARK: - Public
extension DGCLogger {
    static func logInfo(_ message: String, file: NSString = #file, function: String = #function, line: Int = #line) {
        log(message, tag: .info, file: file, function: function, line: line)
    }
    
    static func logError(_ message: String, file: NSString = #file, function: String = #function, line: Int = #line) {
        log(message, tag: .error, file: file, function: function, line: line)
    }
    
    static func logError(_ error: Error, file: NSString = #file, function: String = #function, line: Int = #line) {
